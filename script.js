...
$(".reveal").click(function() {
    ...
    if ((qOne >= 1) && (qTwo === "yes")) {
        ...
        $(".words").text("Green Arrow is a human Star City vigilante/superhero who specializes in the use of the bow and arrow. His real name is Oliver Queen and to the majority of society, he is seen as a former billionaire playboy.");
        ...
        $(".words").text("Batman is a rather dark, dreary, and intelligent human superhero who always appears to be one step ahead of his enemies. To most of the world his is known as Bruce Wayne, a billionaire who owns Wayne Industries.");
